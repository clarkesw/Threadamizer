...
public class EmployeeTestStreams {
	...
	public static void main(String[] args) {		
		...
		//grouping by unit
		Map<Unit,List<Employee>> byUnit = (Map<Unit,List<Employee>>) employeeService.findByUnit();
	...
	private static void findAnyBySkill(Skill withSkill) {
		...
		Optional<Employee> empWithSkill = (Optional<Employee>) employeeService.findAnyEmployeeBySkill(withSkill);
	...
	private static void findFirstById(int id) {
		Optional<Employee> employee = (Optional<Employee>) employeeService.findEmployee(id);
